          ...
          wx.showModal({
            ...
            success: function (res) {
              if (res.confirm) {
                ...
                wx.request({
                  url: 'https://www.iwchuang.cn/ichuang/addCourseExerciseResult.action',
                  method: 'POST',
                  data: JSON.stringify({
                    exercise_name: that.data.course_name,
                    exercise_id: that.data.class_id,
                    member_name: app.globalData.username,
                    member_id: app.globalData.sno,
                    score: that.data.count,
                    point: that.data.count,
                  }),
                  header: {
                    'content-type': 'application/json' // 默认值
                    // 'content-type': 'application/x-www-from-urlencoded;charset=utf-8',
